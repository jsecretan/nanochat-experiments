...
def _document_batches(split, resume_state_dict, tokenizer_batch_size, data_dir=None):
    ...
    data_dir: optional directory containing parquet files (default: dataset.DATA_DIR).
    """
    ddp, ddp_rank, ddp_local_rank, ddp_world_size = get_dist_info()

    parquet_paths = list_parquet_files(data_dir=data_dir)
    assert len(parquet_paths) != 0, "No dataset parquet files found in " + (data_dir or "default dir") + ", did you run dataset.py?"
